...
public class OpenAiAdapter implements AiAdapter {
    ...
    /** 带超时配置的 RestTemplate，见 {@link com.geosaas.config.RestTemplateConfig} */
    private final RestTemplate restTemplate;
    /** 共享 Jackson 2 ObjectMapper（见 {@link com.geosaas.config.JacksonConfig}），不复用则每次 new 独立实例 */
